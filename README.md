# Overview
This repository provides an automated provisioning script for building a TryHackMe AttackBox-styled Kali Linux virtual machine. It is designed to quickly transform a fresh Kali installation into a preconfigured environment.
